...
<body>
    ...
    <div  style=" width:200px;font-size:20px;text-align:center;line-height:20px;color:green;margin-left:40%;">     
           ...
           <div style="position: absolute;top:42%;left:2%;width:90%;background-color: aqua;">
			...
			<th>User Id</th><th>Car No</th><th>Car Model</th><th>Seats</th><th>Source</th><th>Destination</th><th>Departure Time</th><th>Return Time</th><th>Action</th>
			<% 
			try
			{
				Connection con=ConnectionProvider.getCon();
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select * from carpool_usercardetails");		
				...
				while(rs.next())
				{
					...
					out.println("<td align=center><a href=deleteuser_carbyadmin.jsp?userid="+rs.getString(1)+">Delete</a></td>");
					out.println("</tr>");
					}
